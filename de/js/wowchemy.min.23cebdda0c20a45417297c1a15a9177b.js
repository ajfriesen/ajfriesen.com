(() => {
  ...
  (() => {
    ...
    var e = {authors: "Authors", event: "Vortr\xE4ge", post: "Blog", project: "Projekte", publication: "Publikationen", slides: "Slides"}, f = {no_results: "Nichts gefunden", placeholder: "Suche...", results: "Suchergebnisse"}, c = {indexURI: "/de/index.json", minLength: 1, threshold: 0.3}, d = {shouldSort: true, includeMatches: true, tokenize: true, threshold: c.threshold, location: 0, distance: 100, maxPatternLength: 32, minMatchCharLength: c.minLength, keys: [{name: "title", weight: 0.99}, {name: "summary", weight: 0.6}, {name: "authors", weight: 0.5}, {name: "content", weight: 0.2}, {name: "tags", weight: 0.5}, {name: "categories", weight: 0.5}]}, a = 60;
    function g(a2) {
